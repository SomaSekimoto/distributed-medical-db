...
export interface MedicalDatabaseScriptInterface extends utils.Interface {
  functions: {
...
export interface MedicalDatabaseScript extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MedicalDatabaseScriptInterface;
